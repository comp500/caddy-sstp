...
func (p *nativeConnection) lcpUp() {
	if p.lcpState == lcpStateInitial {
		p.lcpState = lcpStateClosed
	}
}

func (p *nativeConnection) lcpDown() {

}

func (p *nativeConnection) lcpOpen() {

}

func (p *nativeConnection) lcpClose() {
